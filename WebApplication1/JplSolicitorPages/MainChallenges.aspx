<%@ Page Title="" Language="C#" MasterPageFile="Jpl.Master" AutoEventWireup="true" CodeBehind="MainChallenges.aspx.cs" Inherits="WebApplication1.WebForm2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="float-left w-75">
        <asp:ListView ID="ChallengesListView" runat="server" DataKeyNames="Id" DataSourceID="SqlDataSource1">
            <ItemTemplate>
